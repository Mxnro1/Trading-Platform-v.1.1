...
*   **Новый блок "Инструкция по работе":** на главной добавлены пошаговые подсказки для старта, принятия решения и проверки перед входом в позицию.
*   **Новый блок "Основные данные":** на главной отображаются ключевые метрики в одном месте:
    *   Сценарий рынка (из вкладки Аналитика).
    *   Оценка уверенности и риск (из вкладки Аналитика).
    *   Объем ликвидаций и число событий (из вкладки Ликвидации).
    *   Количество важных новостей, общее число материалов и источники (из вкладки Новости).
*   **Автосинхронизация данных:** карточки на главной автоматически обновляются после пересчета Аналитики, обновления Ликвидаций и загрузки Новости.
*   **Адаптивность:** новые блоки корректно отображаются на десктопе и мобильных устройствах.
